...
knitr::include_graphics(here::here("eda/bc_election_turnout_files/figure-html/pvp.jpg"))
```
...
knitr::include_graphics(here::here("eda/bc_election_turnout_files/figure-html/pvr.jpg"))
```
...
knitr::include_graphics(here::here("doc/images/scatter_plot.png"))

```

```{r, fig.cap = "Figure 2. Q-Q plot for competitiveness and turnout.", echo = FALSE, out.width='100%'}

knitr::include_graphics(here::here("doc/images/cow_plot.png"))
