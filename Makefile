...
# cleaning the data set and joining tw (cleaning the column names and calculating the turnout and competetiveness. 
...
# exploratory data analysis - visualizing the scatter, violin and correlation plots. 
...
clean: 
	...
	rm -rf doc/images
	rm -rf doc/bc_election_turnout_report.md doc/bc_election_turnout_report.pdf doc/bc_election_turnout_report.html
	rm -rf README.md